 ...
 */
let metaThemeColor = document.querySelector("meta[name=theme-color]").getAttribute("content");
...
!(function () {
	...
	!(function (t) {
		...
		function (t, e, n) {
			...
			var r = null,
				// (gutter + tape width + gutter) * 2 at 960px vw
				// (26px + 41.5px + 26px) * 2
				a = 187,
				s = -1,
				u = -1,
				...
				l = function (t) {
					return (
						...
						document.body.classList.contains("zoom-overlay-open")
							...
							: t.metaKey || t.ctrlKey
							? void window.open(
									t.target.getAttribute("data-original") || t.target.src,
									"_blank"
							  )
							: void (
							...
							},
							{
								...
								value: function () {
									null != this.wrap &&
										...
										this.img.parentNode.classList.remove("zoom-img-wrap"),
		...
		function (t, e, n) {
			...
			document.addEventListener("DOMContentLoaded", function () {
				for (
					var t = document.querySelectorAll("img[data-action='zoom']"), e = 0;
					e < t.length;
					e++
				)
					i.a.setup(t[e]);
